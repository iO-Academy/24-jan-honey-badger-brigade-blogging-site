...
class BlogTest extends TestCase
{
    ...
    {
        $expected = '04/03/24';
        $subject = new Blog(1, 'BlogTitle Test', 'lorem blah blah blah', 3, 'username', '2024-03-04 10:11:03', 1,1);
